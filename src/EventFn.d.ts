...
type MachinaThisEventFn<F extends Fsm, EventName extends SpecialEventNames | keyof F["events"]> = MachinaThis<F> & {
        ...
        deferAndTransition<StateName extends keyof { [key in keyof F["states"] as GetStateArguments<F["states"][key]> extends [] | [any] ? key : never]: any }>(stateName: StateName, ...args: GetStateArguments<F["states"][StateName]>): void;
}
